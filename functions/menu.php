...
// *** legacy need refactor ***  - The Top Menu ( secondary )
...
// *** legacy need refactor ***  Below for split menu effect
// *** legacy need refactor ***  The Top Menu left
...
// *** legacy need refactor ***  The Top Menu right
...
// *** legacy need refactor ***  The Off Canvas Menu ( to get the split menu left side )
...
// *** legacy need refactor ***  The Off Canvas Menu ( to get the split menu right side )
